        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="index.php?action=edit&id=<?php echo $user['id']; ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="username">Tên người dùng</label>
                            <input readonly value="<?php echo $user['username'] ?>" type="text" name="username" required class="form-control" id="username" placeholder="Tên người dùng...">
                            <span style="color: red;font-size: 14px;"><?php echo (isset($errors['username'])) ? $errors['username'] : '' ?></span>
                        </div>
                        <div class="form-group">
                            <label for="fullname">Họ và tên</label>
                            <input value="<?php echo $user['full_name'] ?>" type="text" name="fullname" required class="form-control" id="fullname" placeholder="Họ và tên...">
                            <span style="color: red;font-size: 14px;"><?php echo (isset($errors['fullname'])) ? $errors['fullname'] : '' ?></span>
                        </div>
                        <div class="form-group">
                            <label for="password">Mật khẩu</label>
                            <input value="<?php echo $user['password'] ?>" type="password" name="password" required class="form-control" id="password" placeholder="Mật khẩu...">
                        ...
                        <?php if ($user['avatar']) : ?>
                            ...
                            <?php if ($user['avatar']) : ?>
                                <div class="text-center">
                                    <img src="/uploads/avatars/<?php echo $user['avatar']; ?>" class="img-fluid" alt="Avatar">
                                    <div class="mt-3">
                                        <form action="index.php?action=delete_avatar" method="POST">
