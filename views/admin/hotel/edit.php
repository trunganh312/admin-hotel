...
<head>
    ...
    <style>
        .carousel-item img {
            height: 300px;
            /* Thay đổi chiều cao ảnh theo nhu cầu */
            object-fit: cover;
                    ...
                    <form action="index.php?action=edit&id=<?php echo $hotel['id']; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="amenities[]" id="amenities" multiple class="form-control">
                                <?php foreach ($amenitiesList as $amenity) : ?>
                                    <option <?php echo in_array($amenity['id'], array_column($amenitiesCurrent, 'id')) ? 'selected' : ''; ?> value="<?php echo $amenity['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="city_id" id="city_id" class="form-control">
                                <?php foreach ($cities as $city) : ?>
                                    <option <?php echo $hotel['city_id'] == $city['id'] ? 'selected' : '' ?> value="<?php echo $city['id']; ?>"><?php echo htmlspecialchars($city['name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="district_id" id="district_id" class="form-control">
                                <?php foreach ($districts as $district) : ?>
                                    <option <?php echo $hotel['district_id'] == $district['id'] ? 'selected' : '' ?> value="<?php echo $district['id']; ?>"><?php echo htmlspecialchars($district['name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" <?php echo $hotel['is_hot'] == '1' ? 'checked' : '' ?> type="checkbox" value="1" id="isHot" name="isHot" />
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" <?php echo $hotel['promotion'] == '1' ? 'checked' : '' ?> type="checkbox" value="1" id="isPromotion" name="isPromotion" />
